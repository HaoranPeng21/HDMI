...
def cmd_detect(args):
    ...
    # Auto-merge batch results (always run batch processing)
    ...
    batch_files = {
        'hgt_events': os.path.join(output_dir, f'HGT_events_raw_batch_{args.task_number}.csv'),
        'contig_q': os.path.join(output_dir, f'sequences_contig_q{args.task_number}.fa'),
        'contig_s': os.path.join(output_dir, f'sequences_contig_s{args.task_number}.fa'),
        'matched_q': os.path.join(output_dir, f'sequences_matched_seq_q{args.task_number}.fa'),
        'matched_s': os.path.join(output_dir, f'sequences_matched_seq_s{args.task_number}.fa')
    }
